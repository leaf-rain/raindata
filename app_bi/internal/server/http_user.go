...
func InitUserAuthRouter(Router *gin.RouterGroup, userSvc *service.UserService, log *zap.Logger) {
	api := NewUserApi(userSvc, log)
...
func InitUserRouter(Router *gin.RouterGroup, userSvc *service.UserService, log *zap.Logger) {
	api := NewUserApi(userSvc, log)
...
func NewUserApi(userSvc *service.UserService, log *zap.Logger) *UserApi {
	return &UserApi{
		userSvc: userSvc,
		log:     log,
	}
